...
public class AdornmentController {
	...
	public Response getAdornmentsPaging(
			@Valid @RequestBody BasePagingParam param) {

		List<Adornment> adornmentlist = adornmentService
				.getAdornmentPaging(param);
		return new Response().success(new PagingResult<>(adornmentlist));
	}

	@RequestMapping(value="delete", method = RequestMethod.POST)
	public Response deleteAdornment(@Valid @RequestBody DelAdronmentParam params) {

		return adornmentService.batchDelete(params);
	}
}
